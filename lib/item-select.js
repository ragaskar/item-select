(function() {
  function ItemSelect(selectables) {
    ...
    this.disabled = false;
    this.makeSelectable(selectables);
  }
  ...
  ItemSelect.prototype.makeSelectable = function(selectables) {
    var uninitialized = selectables.not('.selectable');
    uninitialized.addClass('selectable');
    uninitialized.mousedown(function() {
      return false;
    });
    var self = this;
